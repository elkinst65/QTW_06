...
![Figure 10 - Red lines indicate distance error between predicted location (*) and true location (black squares) using k=4](errors.png)
...
In this exercise, we investigated using an alternative k-nearest prediction method using the weighted 
