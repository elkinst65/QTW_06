...
Now, we analyze our three scenarios for both APs included, rejectedAP left out, and then chosenAP left out. Three neighbors were used for three angles. The accuracy for each scenario as determined by the sum of squares difference between estimated X,Y and actual X,Y were outputted as well. Cross-validation was not used at this time.
