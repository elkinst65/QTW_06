...
Plot the signal strength distribution for all locations through the average signal strength for all locations by angle. Summary statistics for all possible locations by angle were created. 
