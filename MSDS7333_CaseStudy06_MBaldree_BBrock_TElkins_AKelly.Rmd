...
K-nearest neighbors approach.  The calculation of the Euclidean distance error was found to be 1194, whereas the Mean SS error was found to be 210.  The Euclidean distance weighted k-nearest neighbors 
method had the highest error, while the Mean SS weighted K-nearest neighbors method had the smaller
error.
