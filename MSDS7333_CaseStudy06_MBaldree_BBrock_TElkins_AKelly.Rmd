...
This evidence would suggest both addresses are kept within the analysis to increase the coverage for the entire spectrum of strengths.
...
### <font color = "red"> &darr; this section may no longer be needed. Now missing from the original code. &darr;</font>  
```{r}
...
```
### <font color = "red"> &uarr; this section may no longer be needed. Now missing from the original code. &uarr;</font>  
